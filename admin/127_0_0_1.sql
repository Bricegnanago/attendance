...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 20 Septembre 2019 à 21:31
...
(2, 'bricegnanago', '$2y$10$y0UANo8d5OvAWkuz1gUXqOsqEfWaQ0ybcA0FGyB4jbUNQkkNGKlVe');
...
--
-- Contenu de la table `tbl_attendance`
--
...
(211, 7, 'Absent', '2019-09-20', 6),
(212, 8, 'Present', '2019-09-20', 6),
(213, 9, 'Absent', '2019-09-20', 6),
(214, 10, 'Present', '2019-09-20', 6),
(215, 11, 'Absent', '2019-09-20', 6);
...
--
-- Contenu de la table `tbl_student`
--
...
(22, 'Jeremy Breawer', 1, '2002-04-11', 1);
...
--
-- Contenu de la table `tbl_teacher`
--
...
(6, 'Ali', 'Abobo', 'ali@eburtis.ci', '$2y$10$IN0UYTVlukRN986iLlls3uRqxVgM1S3EZjMZkfL3z/3A2rWiLuEyy', 'informatique', '2019-09-20', '5d84cd034de99.png', 2);
--
...
CREATE TABLE IF NOT EXISTS `like_table` (
  ...
  `framework` varchar(255) NOT NULL COMMENT 'chaine de framework',
  PRIMARY KEY (`id`)
